...
package com.xinlan.yokirender.math;
...
public class Vector3f extends Tuple3f implements java.io.Serializable {
     ...
     * @param matrix
     */
    public final void multiMatrix(Matrix3f matrix){
        float _x = x;
        float _y = y;
        float _z = z;

        float result_x = _x * matrix.m00 + _y * matrix.m10 + _z * matrix.m20;
        float result_y = _x * matrix.m01 + _y * matrix.m11 + _z * matrix.m21;
        float result_z = _x * matrix.m02 + _y * matrix.m12 + _z * matrix.m22;
